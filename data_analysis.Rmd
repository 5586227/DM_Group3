...
# Creating a profit table that includes a total_profit column for each product incorporating the discount percent and filtering out all "cancelled" orders.
