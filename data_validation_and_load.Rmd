...
#Remove unclean data
bad_order_item_record <- unique(c(duplicate_order_item_composite$order_id,
                                  invalid_order_fk$order_id,
...
#Remove unclean data
bad_advertise_in_record <- unique(c(duplicate_advertise_in_composite$ad_id,
...
for (i in seq_along(tables)) {
  ...
  if ("order_date" %in% colnames(existing)) {
    existing$order_date <- as.Date(existing$order_date)
    new_records$order_date <- as.Date(new_records$order_date)
  }
