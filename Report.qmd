...
According to the E-R diagram and the normalization stage, we can list the logical schema as follows:
...
-   CUSTOMER([customer_ID]{.ul}, first_name, last_name, gender, email, mobile_no, street, city, country, postcode) 
>>>>>>> e8fdc1b6640fb8ba4c0cd6ba94f35c46fae4e48b
...
-   ADVERTISEMENT([ad_id]{.underline}, ad_prequency, ad_place, ad_price) 
=======
-   ADVERTISEMENT([ad_id]{.ul}, ad_number, ad_place, ad_price, product_ID) 

-   SUPPLIER([supplier_id]{.ul}, supplier_name, email, mobile_no) 
>>>>>>> e8fdc1b6640fb8ba4c0cd6ba94f35c46fae4e48b

-   CATEGORY([category_id,]{.ul} category_name, category_fee)
...
=======
-   PRODUCT([product_ID]{.ul}, product_name, product_description, unit_price, stock_at_hand) 
>>>>>>> e8fdc1b6640fb8ba4c0cd6ba94f35c46fae4e48b
...
5.  Delete the database file if it exists.
6.  Run database_schema.Rmd to render database schema.
7.  Run data_validation_and_load.Rmd to render validation and load data into database.
8.  Run data_analysis.Rmd to render data analysis.
9.  Utilize an authentication token to push changes to the 'main' branch.
