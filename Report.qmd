...
![](images/CUSTOMER%202%20DATA%20GEN.png)

![](images/CUSTOMER%203%20DATA%20GEN.png)
...
ggplot(total_sales_by_type, aes(x = Product_Type, y = Total_Quantity_Sold,
  ...
  labs(title = "Total Quantity Sold by Product Type",
       x = "Product Type",
       y = "Total Quantity Sold", caption = "Figure 3") +
  theme_minimal() +
...
revenue_per_region[order(-revenue_per_region$rev),]

top_5_revenue_per_region <- head(top_5_revenue_per_region,10)

#Bar graph to show the revenue per region

ggplot2 <- ggplot(top_5_revenue_per_region,aes(x = reorder(city, -rev),
y=rev,fill=rev))+ 
geom_bar(stat='identity')+
scale_fill_gradient(low = "lightblue", high = "darkblue")+
